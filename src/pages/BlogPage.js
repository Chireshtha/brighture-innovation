    ...
    <Container fluid className='blog-container-1 p-0 m-0'>
      ...
      <Row className='mt-5'>
        <Col md={8} >
          {blogContent.sections.map((section, index) => (
            <div key={index} className='mb-4 ms-2'>
              <h1 className='mb-3 text-center fs-1'> {section.title}</h1>
              <Row className='g-4'>
        ...
        <Col md={4}>
          ...
          <div className='me-2'>
            <h3 className='text-primary fs-4 my-3'>➡️ Popular Posts</h3>
            <Row className='g-2'>
          ...
          <div className='me-2'>
            <h3 className='text-primary fs-4 my-3'>➡️ Featured Topics</h3>
            <Row className='g-2'>
