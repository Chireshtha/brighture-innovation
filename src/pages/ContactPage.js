    ...
    <Container fluid className='contact-main-container p-0'>
      <Container fluid className='contact-main-content p-0'>
        <div className='text-light text-center fw-bold h-100 w-75 contact-content'>
          <h1 className='display-1'>Start Your Journey with <br /><span className='text-primary fst-italic fw-bold'>Brighture</span> <span className='color fst-italic fw-bold'>Innovation</span></h1>
      ...
      <Container fluid className='contact-address'>
        <Row>
          ...
          <div className='w-75 mx-auto'>
            ...
            <address><strong><FaLocationDot size={24} /> Address</strong><br/>123 Tech Street, Abc City, 600001, India</address>
            <address>
            <hr />
            <a href='tel:+91 12345 67890' className='text-decoration-none custom-color'><strong><FaPhoneAlt size={24}/> Phone Number</strong><br />+123 456 7890</a></address>
            <hr />
            <address>
            <a href='mailto:support@example.com' className='text-decoration-none custom-color'><strong><FaEnvelope size={24}/> Email </strong><br /> brightureinnovation@brinnov.com</a></address>
            <hr />
            <address>
            <a href='career/' className='text-decoration-none custom-color'><strong><FaGlobe size={24}/> Website</strong> <br /> www.brinnov.com</a></address>
